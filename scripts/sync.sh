...
SKILLS=(skill-creator hype-review weekly-loop hype-pr hype-coordinate hype-intent hype-studio hype-chalk hype-verify hypeproof-operator) # vendored to consumer/.claude/skills/<name>/
DOCS=(MEMBER-GUIDE.ko.md AGENT-GUIDE.ko.md DOCS-CONTRACT.ko.md HYPE-REVIEW.ko.md HYPE-PR.ko.md WEEKLY-LOOP.ko.md FIVE-SESSION-DELIVERY.ko.md) # vendored to consumer/docs/<file>
