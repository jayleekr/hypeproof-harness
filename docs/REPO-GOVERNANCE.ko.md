...
| `public-product` | `hypeproof-studio`, `sediment`, `hypeprooflab` | public 유지, 외부 PR 허용, main은 PR/CI/review로만 유입, Actions read-only |
| `private-product` | private 제품 repo | 멤버만 접근, main PR 강제, 가능한 경우 branch protection 적용 |
| `content-vault` | 향후 private 콘텐츠 vault repo | 멤버만 접근, 콘텐츠 ingest secret 보호, provider Git 자동 배포 비활성화 |
...
| `jayleekr/hypeprooflab` | public | `public-product` | public code/private authority 기준으로 운영 |
