...
| `content-vault` | `hypeprooflab` | public 전환 전까지 임시 private, 콘텐츠 ingest secret 보호, provider Git 자동 배포 비활성화, vault 변경 workflow 제한 |
...
| `jayleekr/jayleekr.github.io` | public | `public-site` | collaborator-only contribution, PR CI 추가 |
